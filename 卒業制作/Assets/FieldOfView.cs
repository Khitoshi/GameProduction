...
public class FieldOfView : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //light.pointLightInnerAngle = cosHalf;
        //light.pointLightOuterAngle = cosHalf;
        //self.transform.rotation = Quaternion.Euler(0.0f, 0.0f, );
        light.transform.rotation = Quaternion.Euler(0.0f, 0.0f, self.transform.rotation.z);
    }
